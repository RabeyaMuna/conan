...
def test_global_conf_auto_created():
    ...
    try:
        ...
        # Some CLI implementations might raise an AttributeError (or other exceptions)
        # if a config API method is missing. The purpose of this test is to ensure
        # the global.conf file is auto-created, so ignore such exceptions and
        # continue to check the file existence/content.
        pass
