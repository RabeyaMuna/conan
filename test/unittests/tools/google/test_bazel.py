...
from conan.tools.google.bazeldeps import relativize_path as _relativize_path


@pytest.mark.skipif(
    platform.system() == "Windows",
    reason="Remove this skip for Conan 2.x" "Needs conanfile.commands",
)
...
def test_bazel_command_with_config_values():
    ...
    assert (
        "bazel --bazelrc=/path/to/bazelrc build "
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("././my/path/absolute/././", "./", "my/path/absolute"),
        (
            "C:\\my\\path\\absolute\\with\\folder",
            "C:\\",
            "my/path/absolute/with/folder",
        ),
        ("C:\\my\\path\\absolute\\with\\folder", ".*/absolute", "with/folder"),
        (
            "C:\\my\\path\\myabsolute\\with\\folder",
            ".*/absolute",
            "C:\\my\\path\\myabsolute\\with\\folder",
        ),
    ],
