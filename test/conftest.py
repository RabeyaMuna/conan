...
def pytest_runtest_setup(item):
    ...
    for tool_params in tools_params:
        ...
        if result is True:
            ...
            # Optional build tools should be skipped rather than failed when not available
            optional_build_tools = ("cmake", "bazel", "qbs", "scons", "premake", "emcc")
            if tool_name in optional_build_tools:
