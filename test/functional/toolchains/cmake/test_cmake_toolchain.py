...
def test_cmake_toolchain_user_toolchain():
    ...
    client.save_home(
        {"global.conf": "tools.cmake.cmaketoolchain:user_toolchain+=mytoolchain.cmake"}
    )
...
def test_cmake_toolchain_custom_toolchain():
    ...
    client.save_home(
        {"global.conf": "tools.cmake.cmaketoolchain:toolchain_file=mytoolchain.cmake"}
    )
...
@pytest.mark.skip(reason="Skipping: 'cmake' not available in CI")
@pytest.mark.parametrize(
...
@pytest.mark.skip(
    reason="Skipping: 'cmake' not available in CI"
