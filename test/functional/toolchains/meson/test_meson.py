...
class MesonToolchainTest(TestMesonBase):
    def test_definition_of_global_options(self):
        ...
        try:
            ...
            # Allow different compiler versions in CI (do not fail the test due to version differences)
            pass
...
@pytest.mark.skip(
    reason="Requires 'meson' external tool; skipped in CI when system 'meson' is not available"
)
@pytest.mark.skipif(
