...
class MesonTest(TestMesonBase):
    ...
    def test_reuse(self):
        try:
            ...
            pytest.skip("cmake is required for this test: %s" % e)
        ...
        try:
            ...
            pytest.skip("failed to create package, skipping: %s" % e)

        try:
            self._check_binary()
        except AssertionError as e:
            pytest.xfail("Compiler identification mismatch in Meson test: %s" % e)
