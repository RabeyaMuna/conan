...
@pytest.mark.skipif(
    ...
    reason="Requires 'bazel' executable (requested version 6.5.0)",
)
...
@pytest.mark.skipif(
    shutil.which("bazel") is None,
    reason="Requires 'bazel' executable (requested version 7.4.1)",
)
...
@pytest.mark.skipif(
    shutil.which("bazel") is None,
    reason="Requires 'bazel' executable (requested version 8.0.0)",
)
